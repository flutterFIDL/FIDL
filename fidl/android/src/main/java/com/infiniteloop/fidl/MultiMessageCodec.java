 ...
 */
public class MultiMessageCodec implements MessageCodec<Object> {
    private static final String TAG = "MultiMessageCodec#";
    public static final MultiMessageCodec INSTANCE = new MultiMessageCodec();
